...
TEST_F(ChangeStreamStageTest, TransformDropCollFromMigrate) {
...
TEST_F(ChangeStreamStageTest, TransformRenameFromMigrate) {
...
TEST_F(ChangeStreamStageDBTest, TransformDropDatabaseFromMigrate) {
