 ...
 */
class StubMongoProcessInterfaceMockedLookupSingleDocument final : public StubMongoProcessInterface {
public:
    StubMongoProcessInterfaceMockedLookupSingleDocument(deque<DocumentSource::GetNextResult> mockResults)
